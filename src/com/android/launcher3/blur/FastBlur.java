...
public class FastBlur {
    ...
    // translate Drawable to Bitmap 
    public static Bitmap drawableToBitmap(boolean isLand, Drawable drawable, View view){
        Bitmap bitmap;
    ...
    //doBlurForRadius for fadius
    public static Bitmap doBlurForRadius(boolean isLand, Bitmap bitmap, View view){
        float scaleFactor = 8;
        int radius = 22;
